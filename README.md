<div align="center">                                                                                                                                                                                                                                                                                             
  ...
  **Software Engineer | Systems Builder | Full-Stack**                                                                                                                                                                                                                                                             
  ...
  | **Infinite Canvas Tool** *(mini-Excalidraw)* | TypeScript, React, HTML Canvas | Quadtree spatial indexing, **10K+ elements at 60fps**, undo/redo, SVG/PNG export |
  | **Reactive UI Framework** | TypeScript, Custom VDOM, Babel Plugin | Signals-based reactivity, virtual DOM diffing, custom JSX compiler — validated with a Kanban app |
